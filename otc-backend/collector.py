...
BACKEND = os.getenv("SIGNAL_PRO_OTC_BACKEND", "http://127.0.0.1:8787").rstrip("/")
...
async def main():
    if not EMAIL or not PASSWORD:
        raise SystemExit("Configure QUOTEX_EMAIL e QUOTEX_PASSWORD localmente antes de executar.")
    if not SECRET:
